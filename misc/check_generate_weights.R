...
sum(abs(generateWeights(graph) - graph_generate_weights(graph2)))
# [1] 9.57498e-14
...
# [1] 9.57498e-14
microbenchmark(generateWeights(graph), graph_generate_weights(graph2), generateWeights2(w, g), times = 100)
# Unit: milliseconds
# expr      min        lq      mean    median        uq      max neval cld
# generateWeights(graph) 271.3074 351.05725 381.27900 366.52960 405.13855 573.3192   100   c
# graph_generate_weights(graph2)  19.6396  25.02335  27.43096  26.45735  30.01245  44.6063   100 a
