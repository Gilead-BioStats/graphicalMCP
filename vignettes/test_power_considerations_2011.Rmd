...
This vignette demonstrates re-creating table 1 from the Bretz/Maurer/Hommel Stat Med paper in 2011 using graphicalMCP. Here is the target output
...
gt(as.data.frame(table_1[, c(1:3, 6:7, 10:19)])) |> 
  cols_label(
    case    = html("Case<br>#"),
