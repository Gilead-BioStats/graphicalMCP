...
```{r pres-examples-1}
slides_names <- c("lo_pe", "hi_pe", "lo_se1", "hi_se1", "lo_se2", "hi_se2")
names(example_.5_.5$hypotheses) <-
  rownames(example_.5_.5$transitions) <-
  colnames(example_.5_.5$transitions) <- slides_names
...
print(closure_example, precision = 2)
```
