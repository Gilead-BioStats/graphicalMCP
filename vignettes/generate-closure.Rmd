...
```{r power-parent-child, eval=FALSE}
...
```{r plot-power-benchmarks-holm, fig.dim=c(8, 5), eval=FALSE}
benchmarks_plot_standard <-
  ggplot(benchmarks, aes(num_hyps, median, color = char_expression)) +
  geom_point() +
  geom_line() +
...
```{r power-benchmarks-fs, eval=FALSE}
vec_num_hyps <- 2:8 * 2
...
```{r plot-power-benchmarks-fs, fig.dim=c(8, 5), eval=FALSE}
benchmarks_plot_standard <-
  ggplot(benchmarks, aes(num_hyps, median, color = char_expression)) +
  geom_point() +
  geom_line() +
