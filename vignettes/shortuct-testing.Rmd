...
$H_2$ are rejected - we can specify `verbose = TRUE` and obtain it via `test_results_verbose$details$results[[3]]`. # I am not sure if they can be retrieved easily
...
test_results_verbose$details$results[[3]] # To be discussed
```
