...
bench::mark(
  test_graph(graph2, p,
             tests = list(simes = list(1:10)))$hypotheses_rejected,
  test_graph2(graph2, p,
              tests = "simes", groups = list(1:10))$hypotheses_rejected,
...
bench::mark(
  test_graph(graph2, p,
             tests = list(parametric = list(1:10)),
             corr = corr)$hypotheses_rejected,
  test_graph2(graph2, p,
              tests = "parametric", groups = list(1:10),
              corr = corr)$hypotheses_rejected,
