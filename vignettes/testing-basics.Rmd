...
# Parametric
bench::mark(
  test_graph(graph2, p, tests = "p", corr = sim_corr)$outputs$rejected,
  test_graph(graph2, p, tests = "p", corr = sim_corr, verbose = TRUE)$outputs$rejected,
  test_graph(graph2, p, tests = "p", corr = sim_corr, critical = TRUE)$outputs$rejected,
