...
bonf_bench <- bench::mark(
  ...
  `graphicalMCP, test_graph_fast_v (bonf)` =
    graphicalMCP:::test_graph_fast_v(p, intersections = gw_bonf),
  `graphicalMCP, test_graph_fast_v (para)` =
    graphicalMCP:::test_graph_fast_v(p, intersections = gw_para),
  `graphicalMCP, test_graph_fast_v (simes)` =
    graphicalMCP:::test_graph_fast_v(p, intersections = gw_simes),
...
simes_bench <- bench::mark(
  ...
  `test_graph_fast_v (simes-1)` =
    graphicalMCP:::test_graph_fast_v(p, intersections = graphicalMCP:::simes_order4(gw_bonf, p, list(1:m))),
  `test_graph_fast_v (simes-2)` =
    graphicalMCP:::test_graph_fast_v(p, intersections = graphicalMCP:::simes_order4(gw_bonf, p, groups)),
  `test_graph_fast_vms (simes-1)` =
    graphicalMCP:::test_graph_fast_vms(p, intersections = graphicalMCP:::simes_order4(gw_bonf, p, list(1:m))),
  `test_graph_fast_vms (simes-2)` =
    graphicalMCP:::test_graph_fast_vms(p, intersections = graphicalMCP:::simes_order4(gw_bonf, p, groups)),
  `gMCP::gMCP` =
...
para_bench <- bench::mark(
  ...
  `test_graph_fast_vms (para)` =
    graphicalMCP:::test_graph_fast_vms(p, intersections = gw_para),
  `testGraph` =
