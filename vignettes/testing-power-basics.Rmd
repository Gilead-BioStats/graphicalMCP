...
```{r bonferroni-mix-1}
test_graph(ss_graph, p = pvals, alpha = .05)
```
...
```{r simes-all-1}
test_graph(ss_graph, p = pvals, alpha = .05, test_types = "s")
```
