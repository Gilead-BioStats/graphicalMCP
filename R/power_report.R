...
# browser()
      simes_res <- test_graph_fast_simes(
        graph,
        p_sim[row, ],
        test_alpha,
        simes_groups,
      ...
      para_res <- test_graph_fast_parametric(
        graph,
        p_sim[row, ],
        test_alpha,
        para_groups,
      ...
      test_res <- test_res[order(unlist(c(bonf_groups, simes_groups, para_groups)))]
