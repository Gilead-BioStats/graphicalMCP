...
---
    ...
    Output
      ...
      Detailed test values ($test_values) --------------------------------------------
        Intersection Hypothesis       Test    p c_value Weight Alpha Inequality_holds
                1111         H1 parametric 0.01   1.006    0.5 0.025             TRUE
                1111         H2 parametric 0.01   1.006    0.5 0.025             TRUE
                1111         H3      simes 0.01            0.0 0.025            FALSE
                1111         H4      simes 0.01            0.0 0.025            FALSE
                1110         H1 parametric 0.01   1.006    0.5 0.025             TRUE
                1110         H2 parametric 0.01   1.006    0.5 0.025             TRUE
                1110         H3      simes 0.01            0.0 0.025            FALSE
                1101         H1 parametric 0.01   1.006    0.5 0.025             TRUE
                1101         H2 parametric 0.01   1.006    0.5 0.025             TRUE
                1101         H4      simes 0.01            0.0 0.025            FALSE
        ... (Use `print(x, rows = <nn>)` for more)
    ...
    Output
      ...
      Detailed test values ($test_values) --------------------------------------------
        Intersection Hypothesis       Test    p c_value Weight Alpha Inequality_holds
                1111         H1 parametric 0.01   1.006    0.5 0.025             TRUE
                1111         H2 parametric 0.01   1.006    0.5 0.025             TRUE
                1111         H3 parametric 0.01   1.000    0.0 0.025            FALSE
                1111         H4 parametric 0.01   1.000    0.0 0.025            FALSE
                1110         H1 parametric 0.01   1.006    0.5 0.025             TRUE
                1110         H2 parametric 0.01   1.006    0.5 0.025             TRUE
                1110         H3 parametric 0.01   1.000    0.0 0.025            FALSE
                1101         H1 parametric 0.01   1.006    0.5 0.025             TRUE
                1101         H2 parametric 0.01   1.006    0.5 0.025             TRUE
                1101         H4 parametric 0.01   1.000    0.0 0.025            FALSE
        ... (Use `print(x, rows = <nn>)` for more)
