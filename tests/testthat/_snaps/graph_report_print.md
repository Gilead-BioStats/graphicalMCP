    ...
    Output
      ...
      Test details - Critical values -------------------------------------------------
         intersection hypothesis       test    p <=        c *   w * alpha   res
                    1         H1 parametric 0.01 <= 1.012825 * 0.5 *  0.05  TRUE
                    1         H2 parametric 0.01 <= 1.012825 * 0.5 *  0.05  TRUE
                    1         H3      simes 0.01 <=            0.0 *  0.05 FALSE
                    1         H4      simes 0.01 <=            0.0 *  0.05 FALSE
                    2         H1 parametric 0.01 <= 1.012825 * 0.5 *  0.05  TRUE
                    2         H2 parametric 0.01 <= 1.012825 * 0.5 *  0.05  TRUE
                    2         H3      simes 0.01 <=            0.0 *  0.05 FALSE
                    3         H1 parametric 0.01 <= 1.012825 * 0.5 *  0.05  TRUE
                    3         H2 parametric 0.01 <= 1.012825 * 0.5 *  0.05  TRUE
                    3         H4      simes 0.01 <=            0.0 *  0.05 FALSE
                    4         H1 parametric 0.01 <= 1.012825 * 0.5 *  0.05  TRUE
                    4         H2 parametric 0.01 <= 1.012825 * 0.5 *  0.05  TRUE
    ...
    Output
      ...
      Test details - Critical values -------------------------------------------------
         intersection hypothesis       test    p <=        c *   w * alpha   res
                   ...
                   13         H3 parametric 0.01 <= 1.012825 * 0.5 *  0.05  TRUE
                   13         H4 parametric 0.01 <= 1.012825 * 0.5 *  0.05  TRUE
