...
The weights of all subgraphs can be calculated with `generate_weights_recursive()`. This uses some more efficient code under the hood than `update_graph()` in order to be performant for larger graphs.
