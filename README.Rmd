...
- To view vignettes in R after properly installing 'graphicalMCP', we can build vignettes by 'devtools::install(build_vignettes = TRUE)', and then use 'browseVignettes("graphicalMCP")'.
