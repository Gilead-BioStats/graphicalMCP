...
Hypotheses can be deleted from the MCP using `graph_update()`. Updated weights and transitions are calculated according to the weighting strategy in Algorithm 1 of [@bretz-2011]. We distinguish *deleting* from *rejecting* in the [glossary](#glossary-of-terms).
