...
All valid test types & hypothesis groupings are valid for power simulations as well. Power simulations are discussed further in both the [shortcut testing vignette] and the [closure testing vignette].
